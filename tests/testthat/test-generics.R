...
test_that("angles", {
  expect_true(angle(radian = 1) == radian(1))
  expect_true(angle(degree = 30) == degree(30))
  expect_true(angle(turn = .5) == turn(.5))
  expect_true(angle(gradian = 50) == gradian(50))
  expect_identical(degree(10) + 1, degree(11))
...
test_that("intersection", {
  ...
  expect_equal(intersection(l1, c1),
               point(theta = radian(radian = pi * 3 / 4 ), r = 1))
